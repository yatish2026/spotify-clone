...
const Navbar = () => {
  return (
    ...
    <div className='flex items-center gap-2 mt-4'>
      ...
      <p className='bg-green-300 text-white px-4 py-1 rounded-2xl cursor-pointer'>music</p>
      <p className='bg-green-300 text-white px-4 py-1 rounded-2xl cursor-pointer'>podcasts</p>
